...
public class BluetoothDeviceList extends Activity {
	...
	public BluetoothAdapter mBluetoothAdap = null;
	...
	} // intent onCreate method ends here.

	public void bluetoothGetBondedDevices() {
	...
	// action to do when an item in the list is clicked.
	private OnItemClickListener mDeviceClickListener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
			...
			Log.d("BTACTIVITY", "itemClickListener");
	...
	// Whenever a bluetooth device is found, the system will broadcast an
	// action_found intent which is heard by mBroadCastReceiver
